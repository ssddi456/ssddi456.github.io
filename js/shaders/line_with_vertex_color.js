define('js/shaders/line_with_vertex_color', ['require', 'exports', 'module', "./base_shader", "js/shaders/line_with_vertex_color-vs.glsl.js", "js/shaders/line_with_vertex_color-fs.glsl.js"], function(require, exports, module) {
  ...
  var LineWithVertexColorShader = /** @class */ (function (_super) {
      __extends(LineWithVertexColorShader, _super);
      function LineWithVertexColorShader() {
      ...
      LineWithVertexColorShader.prototype.render = function (world, mesh, camaraMatrixFlat, lights) {
          var gl = world.gl;
      ...
      return LineWithVertexColorShader;
  }(base_shader_1.Shader));
  exports.LineWithVertexColorShader = LineWithVertexColorShader;
