define('js/shaders/cube_with_lighting', ['require', 'exports', 'module', "./base_shader", "js/shaders/cube_with_lighting-vs.glsl.js", "js/shaders/cube_with_lighting-fs.glsl.js"], function(require, exports, module) {
  ...
  var CubeWithLightingShader = /** @class */ (function (_super) {
      __extends(CubeWithLightingShader, _super);
      function CubeWithLightingShader() {
      ...
      CubeWithLightingShader.prototype.render = function (world, mesh, camaraMatrixFlat, lights) {
          var gl = world.gl;
      ...
      return CubeWithLightingShader;
  }(base_shader_1.Shader));
  exports.CubeWithLightingShader = CubeWithLightingShader;
