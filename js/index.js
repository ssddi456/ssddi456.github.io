...
define(["require", "exports", "./world", "./shaders/vertex_color_shader", "./shaders/cube_with_texture_and_lighting_shader", "./light", "./mesh", "./libs/plane", "./libs/cube", "./libs/player_control", "./libs/level_control", "./libs/utils", "./objects/merge_canvas"], function (require, exports, world_1, vertex_color_shader_1, cube_with_texture_and_lighting_shader_1, light_1, mesh_1, plane_1, cube_1, player_control_1, level_control_1, utils_1, merge_canvas_1) {
    "use strict";
    ...
    var _a = __read(utils_1.createFrameBufferWithDepth(world.gl, grayFrameTexture, size), 2), grayFrameBuffer = _a[0], grayRenderBuffer = _a[1];
    var colorFrameTexture = utils_1.createTexture(world.gl, size.width, size.height);
    var _b = __read(utils_1.createFrameBufferWithDepth(world.gl, colorFrameTexture, size), 2), colorFrameBuffer = _b[0], colorRenderBuffer = _b[1];
