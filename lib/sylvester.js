...
Vector.prototype = {
    ...
    clone: function () {
        return Vector.create(this.elements.slice(0));
    }
};
...
Matrix.prototype = {
    ...
    clone: function () {
        return Matrix.create( this.elements.map(function ( row ) {
            return row.slice(0);
        }));
    }
};
...
Line.prototype = {
    ...
    clone: function () {
        var copy = new Line();
        copy.anchor = this.anchor.clone();
        copy.direction = this.direction.clone();
        return copy;
    }
};
